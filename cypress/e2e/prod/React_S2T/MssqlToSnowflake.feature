Feature: New s2t river: mssql_to_snowflake
    ...
    Scenario: create new s2t river with mssql and snowflake
        ...
        When I select 'snowflake' as a target and click label "tooltip icon Snowflake"
        Then I click button "Next"
        ...
        When I want save river name with prefix 'e2e-mssql-snowflake'
