...
import { ClusterEditor } from 'modules/SourceTarget/components/SchemaEditor/SchemaTables/TableSettings/Mapping/components/ClusterEditor';
...
export function SnowflakeMapping({ isDisabled }) {
