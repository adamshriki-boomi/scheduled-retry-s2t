...
const SvgExclamationInfoFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={18}
    height={18}
    viewBox="0 0 18 18"
    ...
    {...props}
  >
    <g clipPath="url(#clip0_394_13512)">
      <path
...
export default SvgExclamationInfoFilled;
