export const selectRiver = {
  type: 'river/selectRiver',
  payload: '60755555548271001df7a3c4',
};
export const fetchRiverPayload = {
  type: 'river/fetchRiver/fulfilled',
  payload: {
    cross_id: {
...
export const fetchRiverContainerOnlyPayload = {
  type: 'river/fetchRiver/fulfilled',
  payload: {
    cross_id: {
      $oid: '60755555548271001df7a3c4',
