...
export const getControls = ({ targets }) => [
  ...
  },
  {
    ...
    fontSize: 'xs',
    display_name:
      'Default retry settings applied to new Source to Target Flows.',
    mb: 2,
  },
  {
    type: ControlList.SLIDER,
  ...
  },
  {
    ...
    fontSize: 'xs',
    display_name:
      'How many times to retry a failed run before it stays failed.',
    mb: 3,
  },
  {
    type: ControlList.SLIDER,
    name: 'scheduled_retry_delay_minutes',
    display_name: 'Default delay between retries',
    unitSuffix: 'min',
    min: 1,
    max: 60,
  },
  {
    ...
    color: 'font-secondary',
    fontSize: 'xs',
    display_name: 'How long to wait before each retry.',
    mb: 3,
  },
  {
    type: ControlList.TITLE,
